...
def neighbours_of_position(coords):
    ...
    # Left to right
    left = (row, col -1)
    # The `(row, col)` coord's passed to this function are situated here
    right = (row, col + 1)
...
def all_grid_neighbours(grid):
    """
        Get all of the possible neigh for each position in the grid
    """
    neighbours = {}
...
def search(grid, dictionary):
    ...
    Now: modified! Added full_words and stems
...
def get_dictionary(dictionary_file):
    """
    Load Dictionary file (modified, added stems)
